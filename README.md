# HPC User Account Management Dashboard

A web-based user account information management system developed for the UAB Research Computing HPC environment (Cheaha).
...
- **User Account Information**:
  - View user account status, group memberships, job activity per, and quota usage.
- **Project Allocations**:
...
- **Partition Details**:
  - View available nodes per partition along with detailed node states (e.g., idle, allocated, mixed, draining).
